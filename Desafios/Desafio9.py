# -*- coding: utf-8 -*-
"""
Created on Wed May  4 20:04:58 2022
...
palavras = set()
everlong_foo_fighters = everlong_foo_fighters.replace('\n'," ")
#everlong_foo_fighters = everlong_foo_fighters.replace("'","")
for palavra in everlong_foo_fighters.split(" "): # para cada linha do arquivo
    palavras.add(palavra) # adiciona a palavra no set

palavras_em_ordem = sorted(palavras)
palavras_em_ordem = " ".join(palavras_em_ordem)
print(f"\nSaida: \n\n{palavras_em_ordem}")
